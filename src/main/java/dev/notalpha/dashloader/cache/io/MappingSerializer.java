...
public class MappingSerializer {
	...
	public MappingSerializer(List<DashCacheHandler<?>> cacheHandlers) {
	...
	public void save(Path dir, RegistryFactory factory, List<DashCacheHandler<?>> handlers, StepTask parent) {
		List<WeightedStageTask.WeightedStage> tasks = new ArrayList<>();
		for (DashCacheHandler<?> value : handlers) {
