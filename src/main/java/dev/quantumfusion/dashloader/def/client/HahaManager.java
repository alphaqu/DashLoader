...
public class HahaManager {
	private static final String[] FACTS = {
			...
			"Facebook had a worse time than you.",
			"Whatsapp had a worse time than you.",
			"Instagram had a worse time than you.",
			"Messager had a worse time than you.",
			"Twitch had a worse time than you.",
			"Steve is almost as chad as Chuck Norris",
			"IKEA is traditional.",
			"1 + 1 = 11",
			"Who knew a pipebomb was a bomb.",
			"QuantumFusion: *explodes*",
			"https://ko-fi.com/notequalalpha",
			"#alphastroke is the best channel",
			"USB-C is gud.",
			"Modrinth gud.",
			"Microsoft Teams is bad",
